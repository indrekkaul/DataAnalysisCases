...
3.  Import data. Put all downloaded files into C:/Download/ folder.

```{r}
data1 <- read.csv("C:/Download/tripdata_datasets/202305-divvy-tripdata.csv")
data2 <- read.csv("C:/Download/tripdata_datasets/202306-divvy-tripdata.csv")
data3 <- read.csv("C:/Download/tripdata_datasets/202307-divvy-tripdata.csv")
data4 <- read.csv("C:/Download/tripdata_datasets/202308-divvy-tripdata.csv")
data5 <- read.csv("C:/Download/tripdata_datasets/202309-divvy-tripdata.csv")
data6 <- read.csv("C:/Download/tripdata_datasets/202310-divvy-tripdata.csv")
data7 <- read.csv("C:/Download/tripdata_datasets/202311-divvy-tripdata.csv")
data8 <- read.csv("C:/Download/tripdata_datasets/202312-divvy-tripdata.csv")
data9 <- read.csv("C:/Download/tripdata_datasets/202401-divvy-tripdata.csv")
data10 <- read.csv("C:/Download/tripdata_datasets/202402-divvy-tripdata.csv")
data11 <- read.csv("C:/Download/tripdata_datasets/202403-divvy-tripdata.csv")
data12 <- read.csv("C:/Download/tripdata_datasets/202404-divvy-tripdata.csv")
```
